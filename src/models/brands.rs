...
pub struct Brands {
  ...
  #[serde(rename = "content")] content: Vec<::models::Brand>
}

impl Brands {
  /// Zalando API Paged Brands Schema
  pub fn new(total_elements: i32, total_pages: i32, page: i32, size: i32, content: Vec<::models::Brand>) -> Brands {
    Brands {
  ...
  pub fn with_total_elements(mut self, total_elements: i32) -> Brands {
    self.total_elements = total_elements;
    self
  }
  ...
  pub fn with_total_pages(mut self, total_pages: i32) -> Brands {
    self.total_pages = total_pages;
    self
  }
  ...
  pub fn with_page(mut self, page: i32) -> Brands {
    self.page = page;
    self
  }
  ...
  pub fn with_size(mut self, size: i32) -> Brands {
    self.size = size;
    self
  }
  ...
  pub fn set_content(&mut self, content: Vec<::models::Brand>) {
    self.content = content;
  }

  pub fn with_content(mut self, content: Vec<::models::Brand>) -> Brands {
    self.content = content;
    self
  }
